...
interface Prompt {
  ...
  description: string;
  content: string;
  model?: string; // Optional: only for classification and extraction
}
  ...
  const savePrompts = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Failed to save prompts:", response.status, response.statusText);
        setSaveStatus("error");
        setTimeout(() => setSaveStatus("idle"), 3000);
      }
    } catch (error) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                {/* Model selection - only for classification and extraction */}
                {(activeTab === "classification" || activeTab === "extraction") && (
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Model
                    ...
                    <select
                      value={prompts[activeTab as keyof PromptsData].model || "gpt-4o-2024-08-06"}
                      onChange={(e) => updatePrompt(activeTab as keyof PromptsData, "model", e.target.value)}
                    ...
                    >
                      <optgroup label="GPT-5 (Next Generation - Preview)">
                        <option value="gpt-5-mini-2025-08-07">gpt-5-mini-2025-08-07 (Preview)</option>
                      </optgroup>
                      <optgroup label="GPT-4o (Recommended - Fast & Accurate)">
                        <option value="gpt-4o">gpt-4o (latest)</option>
                        <option value="gpt-4o-2024-11-20">gpt-4o-2024-11-20</option>
                        <option value="gpt-4o-2024-08-06">gpt-4o-2024-08-06</option>
                        <option value="gpt-4o-2024-05-13">gpt-4o-2024-05-13</option>
                      </optgroup>
                      <optgroup label="GPT-4o Mini (Fast & Cost-Effective)">
                        <option value="gpt-4o-mini">gpt-4o-mini (latest)</option>
                        <option value="gpt-4o-mini-2024-07-18">gpt-4o-mini-2024-07-18</option>
                      </optgroup>
                      <optgroup label="GPT-4 Turbo (High Performance)">
                      ...
                      <optgroup label="GPT-4 Vision (Legacy)">
                        <option value="gpt-4-vision-preview">gpt-4-vision-preview</option>
                      </optgroup>
                    </select>
                    <div className="mt-2 space-y-1">
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        💡 <strong>Recommended:</strong> gpt-4o (latest) - Best balance of speed, accuracy, and cost
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        ⚡ <strong>For speed/cost:</strong> gpt-4o-mini - Up to 60% cheaper, still highly accurate
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        🎯 <strong>For maximum accuracy:</strong> gpt-4-turbo - Highest quality vision processing
                      </p>
                    </div>
                  </div>
                )}
